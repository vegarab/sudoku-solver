...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        raise ValueError("Must provide sudoku board!")

    csp = create_sudoku_csp(str(file_name)) 
    solution = csp.backtracking_search()
    print_sudoku_solution(solution)

    print "\nBacktrack called {} times, failed {} times".format(csp.backtrack_counter, csp.failure_counter) 
